...
import { getProjectDurationFrames, isProjectReadyForExport } from '../../types/ProjectNew';
...
export const ExportStep: React.FC<ExportStepProps> = ({
  ...
  // Isso garante que os valores padrão sejam aplicados mesmo sem interação do usuário
  useEffect(() => {
  ...
  const { ready, issues } = isProjectReadyForExport(project);
  ...
  // Nota: O Player do Remotion não suporta setPlaybackRate diretamente,
  // mas mantemos o estado para exibir a velocidade selecionada
